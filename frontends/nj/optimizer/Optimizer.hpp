...
#include "optimizer/NJOptimizer.hpp"

namespace TR
{

class Optimizer : public NJCompiler::OptimizerConnector
   {
   public:
   ...
   Optimizer(TR::Compilation *comp, TR::ResolvedMethodSymbol *methodSymbol, bool isIlGen,
      ...
      NJCompiler::OptimizerConnector(comp, methodSymbol, isIlGen, strategy, VNType) {}
   };
